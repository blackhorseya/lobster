...
import (
	...
	task "github.com/blackhorseya/lobster/internal/pkg/entity/todo"
)
...
func (_m *IRepo) QueryByID(ctx contextx.Contextx, id int64) (*task.Task, error) {
	ret := _m.Called(ctx, id)

	var r0 *task.Task
	if rf, ok := ret.Get(0).(func(contextx.Contextx, int64) *task.Task); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*task.Task)
